...
const {createArticle, getAllArticles, getArticleById, deleteArticle,updateArticle,addComment,dashboard, getAllArticlesIndex} =require( '../controllers/article-contoller.js')
...
router.get('/',getAllArticlesIndex)
